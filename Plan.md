...
## Доработка страницы «Поиск»
- [Plan-Search.md](Plan-Search.md) — план и **результаты** доработки: autocomplete городов/отелей, «Проверить гостиницу», «Мой выбор» (my-choice.html), скачивание карточки в .md
